...
const samplePosts: CommunityPost[] = [
  {
    ...
    author: '김건강',
    avatar: '👨‍⚕️',
    title: '새로운 운동 루틴 공유합니다!',
    content: '최근에 시작한 HIIT 운동이 정말 효과적이네요. 30분만에 칼로리 소모가 엄청나요. 함께 운동하실 분들 있나요?',
    likes: 24,
    comments: 8,
    shares: 3,
    timestamp: '2시간 전',
    ...
    commentList: [
      {
        ...
        author: '박운동',
        avatar: '💪',
        content: '저도 HIIT 운동 해보고 싶어요! 어떤 루틴인지 자세히 알려주세요.',
        timestamp: '1시간 전'
      },
      {
        id: 'c2',
        author: '김체력',
        avatar: '🏃‍♂️',
        content: '정말 효과적이죠! 저도 3개월째 하고 있는데 체력이 많이 좋아졌어요.',
        timestamp: '30분 전'
      }
    ]
  },
  {
    ...
    avatar: '👩‍🍳',
    title: '건강한 식단 레시피 추천',
    content: '단백질이 풍부한 닭가슴살 샐러드 레시피를 공유합니다. 간단하면서도 맛있어요!',
    likes: 18,
    comments: 12,
    shares: 5,
    timestamp: '4시간 전',
    ...
    commentList: [
      {
        ...
        author: '이요리',
        avatar: '👨‍🍳',
        content: '레시피 정말 유용해요! 오늘 저녁에 만들어봐야겠어요.',
        timestamp: '3시간 전'
      }
    ]
  },
  {
    ...
    avatar: '🧘‍♀️',
    title: '명상과 마음챙김의 중요성',
    content: '스트레스 관리에 명상이 정말 도움이 됩니다. 하루 10분만 투자해보세요.',
    likes: 31,
    comments: 15,
    shares: 7,
    timestamp: '6시간 전',
