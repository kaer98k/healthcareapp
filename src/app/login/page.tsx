      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center px-4 py-3 border border-yellow-300 rounded-lg bg-yellow-400 text-gray-900 hover:bg-yellow-500 transition-colors disabled:opacity-50"
          >
        ...
        <div className="mt-8 text-center">
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Healthcare App</h2>
          <p className="text-gray-600 text-sm">
            건강 관리 및 운동 추천 애플리케이션
          </p>
        </div>
      </div>
    </div>
