...
const GoogleSignIn: React.FC<GoogleSignInProps> = ({ onSuccess, onError }) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="utility-button w-full flex items-center justify-center py-3 px-4 text-base font-medium transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {loading ? (
        <>
