...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 z-50 group"
